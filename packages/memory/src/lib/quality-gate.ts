...
export const BANNED_PHRASES = [
  ...
  /\bconsider\s+(using|adopting|implementing|switching|creating|building|adding|whether)\b/i,
  /\bthink about\s+(how|what|whether|ways)\b/i,
  /\bdon't forget\b/i,
  /\bpromoting\b.*\bseparation of concerns\b/i,
  /\bcleaner\b.*\barchitecture\b/i,
  /\bbest practice\s+(is|to|for|would be|should be|that)\b/i,
  /\bensur(?:es?|ing)\b.*\bmaintainab/i,
  /\b(it'?s|it is)\s+important to\b/i,
  /\bkeep in mind\s+that\b/i,
  /\b(it'?s|it is)\s+worth noting\b/i,
  /\bhelps with\s+(maintainability|readability|scalability|modularity|reusability)\b/i,
